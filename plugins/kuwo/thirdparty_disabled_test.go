...
func TestDisabledThirdPartyPreservesKuwoOfficialResult(t *testing.T) {
	for _, failed := range []bool{false, true} {
		...
		got, err := resolveKuwoDownload(t.Context(), thirdparty.ModeDisabled, official, thirdParty, "track", platform.QualityLossless)
