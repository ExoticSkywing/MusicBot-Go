...
var intentionallyEnglish = map[string]bool{
	...
	"platform_name_douyin":              true,
	"platform_name_fivesing":            true,
	"platform_name_jamendo":             true,
	"platform_name_joox":                true,
	"platform_name_kugou":               true,
	"platform_name_kuwo":                true,
	"platform_name_migu":                true,
	"platform_name_netease":             true,
	"platform_name_qianqian":            true,
	...
	"platform_button_name_douyin":       true,
	"platform_button_name_fivesing":     true,
	"platform_button_name_jamendo":      true,
	"platform_button_name_joox":         true,
	"platform_button_name_kugou":        true,
	"platform_button_name_kuwo":         true,
	"platform_button_name_migu":         true,
	"platform_button_name_netease":      true,
	"platform_button_name_qianqian":     true,
